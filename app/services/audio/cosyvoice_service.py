...
class CosyVoiceAudioService:
    def __init__(self, audio_seed=0, audio_speed="normal",
                 refer_wav_path=None, prompt_text=None,
        ...
        self.audio_seed = int(audio_seed)
        ...
        self.reference_audio_language = reference_audio_language
