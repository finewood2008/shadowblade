...
class GPTSoVITSAudioService:
    def __init__(self, audio_temperature=0.3, audio_top_p=0.7, audio_top_k=20,
                 audio_speed="normal", refer_wav_path=None, prompt_text=None,
                 prompt_language=None, text_language="zh"):
        super().__init__()
        ...
        speed_map = {
            "normal": 1.0, "fast": 1.1, "slow": 0.9,
            "faster": 1.2, "slower": 0.8,
            "fastest": 1.3, "slowest": 0.7,
        }
        self.audio_speed = speed_map.get(audio_speed, 1.0)

        if refer_wav_path:
            self.refer_wav_path = refer_wav_path
            self.prompt_text = prompt_text or ""
            self.prompt_language = prompt_language or "zh"

        self.text_language = text_language or "zh"
