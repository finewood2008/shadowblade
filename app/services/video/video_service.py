...
class VideoMixService:
    def __init__(self, fps=30, segment_min_length=3, segment_max_length=8,
                 target_width=1080, target_height=1920,
                 enable_background_music=False, background_music="",
                 background_music_volume=0.3,
                 enable_video_transition_effect=False,
        ...
        self.video_transition_effect_type = video_transition_effect_type
        self.video_transition_effect_value = video_transition_effect_value
...
class VideoService:
    def __init__(self, video_list, audio_file, fps=30,
                 seg_min_duration=3, seg_max_duration=8,
                 target_width=1080, target_height=1920,
                 enable_background_music=False, background_music="",
                 background_music_volume=0.3,
                 enable_video_transition_effect=False,
        ...
        self.fps = fps
        self.seg_min_duration = seg_min_duration
