      ...
      <main className={styles.main}>
        <div className={styles.container}>
          <div className={styles.header}>
            <h1 className={styles.title}>火花 Extension Privacy Policy</h1>
          ...
          <div className={styles.content}>
            <section className={styles.section}>
              <p className={styles.introduction}>
                This Privacy Policy describes how 火花 Extension ("Extension", "we", "us", or
                "our") collects, uses, and protects information when you use our browser extension.
                By installing and using the 火花 Extension, you agree to the collection and use
            ...
            <section className={styles.section} id="section1">
              ...
              <p className={styles.sectionContent}>
                火花 Extension is a browser extension designed to help users automate content
                publishing, engagement, and social media tasks seamlessly with the 火花 web
            ...
            <section className={styles.section} id="section3">
              ...
              <p className={styles.sectionContent}>
                The 火花 Extension requires certain browser permissions to function. Here's why
              ...
              <ul className={styles.listContent}>
                ...
                <li>aitoearn.ai - For communication with 火花 web platform</li>
              </ul>
            </section>
            ...
            <section className={styles.section} id="section4">
              ...
              <ul className={styles.listContent}>
                ...
                <li>To synchronize data with the 火花 web platform</li>
            ...
            <section className={styles.section} id="section5">
              ...
              <p className={styles.sectionContent}>
                Certain data may be transmitted to and stored on 火花 servers to enable
            ...
            <section className={styles.section} id="section7">
              ...
              <h3 className={styles.subSectionTitle}>With 火花 Platform</h3>
              <p className={styles.sectionContent}>
                Data is shared between the extension and the 火花 web platform to provide
              ...
              <p className={styles.sectionContent}>
                ...
                request, or to protect the rights, property, or safety of 火花, our users, or
                others.
              </p>
            </section>
