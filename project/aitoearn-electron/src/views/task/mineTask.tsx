        ...
        <div className={styles.guideStep}>
          ...
          <div className={styles.qrCodeContainer}>
            ...
            <div className={styles.qrCodeItem}>
              ...
              <p className={styles.qrCodeSubtext}>手机扫码火花公众号</p>
            </div>
          </div>
        </div>
      ...
      >
        <div className={styles.guideContainer}>
          ...
          <p>
            ...
            <p>
              您好，为了更好地保障广告主和流量主的权益，建立一个健康、公平的广告交易系统，请仔细阅读并确认以下"《火花任务市场接单合作须知》"后再操作接单：
            </p>
            <p>
              火花任务市场服务：指火花为流量主和广告主提供的撮合交易以及技术支持服务。火花在此过程中提供平台的运营与维护，监督管理平台内经营主体及交易行为，提升广告主与流量主交易体验。
            </p>
          </div>
          ...
          <div className={styles.guideSection}>
            ...
            <ol className={styles.guideSteps}>
              ...
              <li>
                <p>点击下方链接下载火花接单软件（已下载可忽略）</p>
                <p className={styles.guideLink}>https://att.yikart.cn/huohua</p>
              </li>
              <li>
                <p>
            ...
            <div className={styles.guideFaq}>
              <div className={styles.faqItem}>
                ...
                <div className={styles.faqAnswer}>
                  <p>
                  1.1流量主须自行负责在火花平台的用户账号和密码，且须对在用户账号密码下发生的所有活动（包括但不限于发布需求信息、网上点击同意各类协议、规则、参与需求投标等）承担责任。流量主有权根据需要更改登录和账户提现密码。如因流量主的过错导致的任何损失由流量主自行承担，该过错包括但不限于：不按照交易提示操作，未及时进行交易操作，遗忘或泄漏密码等。
                  </p>
                  <p >
                  1.2流量主应当注册账户时提供真实准确的注册信息，包括但不限于真实姓名、身份证号、联系电话、地址、邮政编码等，保证火花工作人员可以通过上述联系方式与流量主进行联系。与此同时，流量主也应当在相关资料实际变更时及时更新有关注册资料。
                  </p>
                </div>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <div className={styles.faqAnswer}>
                  <p>
                  2.1针对推广内容，火花任务市场平台有权对广告主投放内容进行初步审核，并对其中明显涉嫌违反法律法规的内容进行强制性处理，但平台的审核仅为形式审核，重在参照广告法条款进行审核，但因每个社交媒体平台自身规则差异造成的内容违规或下架，火花不承担相关责任。
                  </p>
              ...
              <div className={styles.faqItem}>
                <h4>三.发布与结算</h4>
                <div className={styles.faqAnswer}>
                  <p>3.1流量主如约完成推送后，推广信息因相关政策或其它非流量主主动因素导致被删除（包括但不限于：用户举报、平台通知配合删除等），如账号数据正常、账号质量过关且在结算期内，火花任务市场平台应当按照统计金额向乙方支付费用。</p>
                  <p>3.2流量主发布订单内容后，因自身原因人为删除、隐藏、账号封禁等情况导致广告主推广内容不能正常展示推广的，须按照对应订单要求补发或协商处理，否则会受到相应接单限制或处罚。</p>
                  <p>3.3流量主不得擅自更改接单推广信息，包括但不限于标题、图片、视频、音频、文字等（与火花任务市场工作人员沟通确认后的更改除外），如擅自更改将不予结算并影响接单权限。</p>
                  <p>3.4火花任务市场订单实行发布后结算方式，结算金额实时到达流量主火花账户，流量主自行提现操作，平台不收取提现服务费。</p>
                </div>
              </div>
